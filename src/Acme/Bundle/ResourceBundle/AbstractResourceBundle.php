...
use Acme\Bundle\ResourceBundle\DependencyInjection\Compiler\ResolveDoctrineTargetEntitiesPass;
// use Acme\Bundle\ResourceBundle\DependencyInjection\Driver\Exception\UnknownDriverException;
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        if (null !== $this->getModelNamespace()) {
            ...
            foreach ($className::getSupportedDrivers() as $driver) {
                ...
                // echo $compilerPassClassName . ":" . $compilerPassMethod;
                ...
                if (class_exists($compilerPassClassName)) {
                    ...
                    switch ($this->mappingFormat) {
                        ...
                        case ResourceBundleInterface::MAPPING_YAML:
                            // echo 'YML::' . $this->getConfigFilesPath() . '=>' . $this->getModelNamespace() . '||';
                            // echo sprintf('%s.object_manager', $this->getBundlePrefix()) . '\n';
                            // echo sprintf('%s.driver.%s', $this->getBundlePrefix(), $driver);
