...
// use Acme\Bundle\ResourceBundle\Form\DefaultFormFactory;
// use Acme\Component\Resource\Event\ResourceEvent;
...
class ResourceController extends FOSRestController
{
    ...
    {
        if (!$this->container->has('acme.authorization_checker')) {
            return true;
        }
        ...
        if ($permission) {
            ...
            if (!$this->get('acme.authorization_checker')->isGranted($grant)) {
